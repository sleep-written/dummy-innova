...
@Component({
  selector: 'app-base-companies',
  standalone: false,
  templateUrl: './base-companies.html',
  styleUrl: './base-companies.scss',
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class BaseCompanies extends GridComponent<BaseCompaniesItem> implements OnInit {
  ...
  override async getData(): Promise<GridView<BaseCompaniesItem> | null> {
    try {
      return this.#service.get(this.dataRequest);
