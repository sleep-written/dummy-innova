...
export class CreateDb1770733256240 implements MigrationInterface {
    name = 'CreateDb1770733256240'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "base_companies" ("company" int NOT NULL IDENTITY(1,1), "active" bit NOT NULL CONSTRAINT "DF_fa78f139e5d39f7da5fb9aaa204" DEFAULT 0, "code" nvarchar(30) NOT NULL, "name" nvarchar(30) NOT NULL, "description8" nvarchar(80) NOT NULL, CONSTRAINT "PK_4ba5794baa85ff9f19d0ffd14d1" PRIMARY KEY ("company"))`);
